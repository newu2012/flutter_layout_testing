...
class MockFooderlichService {
  ...
  Future<List<ExploreRecipe>> _getTodayRecipes() async {
    ...
    final dataString = await _loadAsset(
      'assets/FooderlichApp/sample_data/sample_explore_recipes.json',
    );
    // Decode to json
  ...
  Future<List<Post>> _getFriendFeed() async {
    ...
    // Load json from file system
    final dataString = await _loadAsset(
      'assets/FooderlichApp/sample_data/sample_friends_feed.json',
    );
    // Decode to json
    final Map<String, dynamic> json = jsonDecode(dataString);
  ...
  Future<List<SimpleRecipe>> getRecipes() async {
    ...
    // Load json from file system
    final dataString = await _loadAsset(
      'assets/FooderlichApp/sample_data/sample_recipes.json',
    );
    // Decode to json
    final Map<String, dynamic> json = jsonDecode(dataString);
